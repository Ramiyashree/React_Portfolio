  ...
  render() {
    ...
    <div className="primary outer-structure" style={{ display: "flex", flexDirection: "column"}}>
        ...
        <Container fluid style={{ padding: "5em" }}>
         ...
         <Col  xs lg="2"><picture><img className="header-img" src={INLogo} alt="header" fluid /></picture></Col>
         <Col className ="pad-down"> 
         <Row><h5>Mobile Engineer Intern at Linkedin, June 2022 - August 2022</h5></Row>
           <Row><ul>
             <li><h6>Working on a new reactions feature for Android app in Feed Conversations Team.</h6></li>
           </ul></Row>
        </Col>
        </Row>
          <Row className="justify-content-md-center pad-down">
         ...
         <Col className ="pad-down"> 
         <Row><h5>Graduate Assistant at University of Illinois at Chicago, April 2020 - May 2022</h5></Row>
           <Row><ul>
